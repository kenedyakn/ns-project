...
def process_collections_workbook(workbook):
    ...
    process_sheets_collections(workbook, sheets)
...
def process_sheets_collections(workbook, sheets):
    for sheet_name in sheets:
        ...
        process_data_collections(workbook, sheet, total_rows, total_cols)


def process_data_collections(workbook, sheet, total_rows, total_cols):
    add_to_db_collections(workbook, sheet, total_rows, total_cols)
